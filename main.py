...
This process serves main_app on port 8000 and mounts ai_gen when
...
SOCIAL_ROOT = PROJECT_ROOT / "main_app"
AI_GEN_ROOT = PROJECT_ROOT / "ai_gen"
...
app = FastAPI(
    ...
    description=(
        "Scheme-A Project entry. main_app is mounted in-process; "
...
try:
    ...
    print(f"ai_gen router not mounted: {exc}")
