...
(17, 'REGEX', 'harassment', '重複傳訊', NULL, 0.05, NULL, NULL, 1),
(18, 'REGEX', 'harassment', '連續追問', NULL, 0.15, NULL, NULL, 1),
(19, 'REGEX', 'harassment', '未讀仍持續傳訊', NULL, 0.15, NULL, NULL, 1),
...
(8, '殺死你', 'violence_threat', 'block', 1, '2026-05-29 15:38:39'),
(9, '強姦你', 'sexual_violence_threat', 'block', 1, '2026-05-29 15:38:39'),
(10, '傳裸照給我', 'sexual_demand', 'block', 1, '2026-05-29 15:38:39'),
(11, '拍裸照給我', 'sexual_demand', 'block', 1, '2026-05-29 15:38:39');
...
(1, 'midnight_aggressive_harassment', '深夜時段、高頻發送且語意包含性暗示之複合判定', '{\"nlp_sexual_min\": 0.3, \"rule_freq_min\": 0.7, \"is_midnight\": true}', '{\"sexual_boundary\": 0.3, \"harassment\": 0.2}', 1),
(2, 'midnight_sexual_push', '深夜時段且具備中等性暗示，視為高風險衝動行為', '{\"nlp_sexual_min\": 0.4, \"is_midnight\": true}', '{\"sexual_boundary\": 0.3, \"harassment\": 0.2}', 1),
...
(12, 'abnormal_acceleration_grooming', '認識時間極短但親密度迅速飆升，符合掠奪者加速關係進程特徵', '{\"familiarity_max\": 0.3, \"intimacy_min\": 0.6, \"progression_rate_min\": 0.1}', '{\"manipulation\": 0.4, \"sexual_boundary\": 0.2}', 1),
(13, 'stable_familiar_relationship', '長期互動且頻率對稱，對邊界語句的容忍度應提高', '{\"familiarity_min\": 0.7, \"balance_range\": [0.4, 0.6]}', '{\"manipulation\": -0.4, \"harassment\": -0.4, \"sexual_boundary\": -0.3, \"emotional_pressure\": -0.3}', 1),
(14, 'one_way_persistence_harassment', '對話高度失衡，且對話親密度停留在低度互動，代表任一方可能存在單向持續施壓', '{\"imbalance_min\":0.6,\"intimacy_max\":0.3,\"total_messages_min\":10}', '{\"harassment\": 0.3, \"emotional_pressure\": 0.2}', 1);
