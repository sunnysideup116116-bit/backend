...
- 主動關心：`test_proactive_*`；驗證 source／room scope、typed candidate create/update/close、cap／expiry、48 小時與週上限、quiet／Calendar busy gate、shadow 不送出、grounding 與不重複投遞。
