...
google_calendar_connections_coll = db["google_calendar_connections"]
google_calendar_oauth_states_coll = db["google_calendar_oauth_states"]
ai_rooms_coll = db["ai_rooms"]
notification_threads_coll = db["notification_threads"]
notification_presence_coll = db["notification_presence"]
contact_selections_coll = db["v3_contact_selections"]
