...
EXPECTED_ROUTES = {
    ...
    ("GET", "/api/push/preferences"): (None, ("user_id",)),
    ("GET", "/api/relationship/date/pending"): (None, ("user_id",)),
    ...
    ("POST", "/api/demo/events/invitations/scan"): (
        None, ("confirm", "max_proposals"),
    ),
    ("POST", "/api/demo/events/reset"): (None, ("confirm",)),
    ...
    ("POST", "/api/pair/risk_feedback/status"): ("RiskFeedbackStatusRequest", ()),
    ("POST", "/api/pair/risk_report"): ("ReceiverReportProxyRequest", ()),
    ("POST", "/api/pair/risk_report_user"): ("ReportUserProxyRequest", ()),
    ("POST", "/api/pair/risk_unblock"): ("UnblockUserProxyRequest", ()),
    ("POST", "/api/presence"): ("ClearRequest", ()),
    ("POST", "/api/push/read"): ("PushReadRequest", ()),
    ...
    ("PATCH", "/api/push/preferences"): ("PushPreferenceRequest", ()),
    ("PUT", "/api/push/presence"): ("PushPresenceRequest", ()),
