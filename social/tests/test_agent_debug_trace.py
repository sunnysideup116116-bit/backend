"""Shared agent diagnostic trace regression tests."""
import unittest
...
from services.ayue_agent.shared.debug_trace import append_event, begin_run, finish_run, get_run
...
class AgentDebugTraceTests(unittest.TestCase):
