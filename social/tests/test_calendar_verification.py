"""Shared Calendar verification regression tests."""
import os
import unittest
from unittest.mock import patch

from services.ayue_agent.shared.calendar_state import (
    clear_runtime_state,
...
class CalendarMutationVerificationTests(unittest.TestCase):
    ...
    def test_verification_is_a_read_tool_without_destructive_arguments(self):
        ...
        with patch(
            "services.ayue_agent.shared.calendar_state.verify_recent_mutation",
            return_value={
