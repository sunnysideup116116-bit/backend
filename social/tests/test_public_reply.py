"""Public reply validation regression tests."""
import unittest

from services.ayue_agent.shared.public_reply import build_presentation, validate_public_reply


class PublicReplyTests(unittest.TestCase):
